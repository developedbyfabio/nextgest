...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        // Disco FIXO e CENTRAL (não suffixado por tenant). O endpoint global de
        // upload (`/livewire/upload-file`) roda SEM tenancy; já o ciclo do
        // componente (`/update`, `salvar`) roda COM tenancy. Se o disco temporário
        // fosse `local` (que é suffixado pela tenancy), o arquivo gravado no upload
        // (disco central) sumiria ao ser lido no /update (disco do tenant) →
